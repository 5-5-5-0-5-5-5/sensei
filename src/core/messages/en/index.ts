...
export { VigiaOcultaMensagens } from './guardian/index.js';
export { LicensasMensagens } from './licensas/index.js';
...
export { PluginCoreMensagens, PluginRegistryMensagens } from './shared/index.js';
